/** Shared narrative: values, leadership, Saudi agriculture — import on pages for consistency. */
...
/** One line each — for compact UI (e.g. product strips). */
export const brandValueTeasers = [
  { title: "Science", line: "Sensors, recirculation, repeatable flavour." },
  { title: "Soul", line: "Heritage in how we pack, partner, and show up." },
  { title: "Future", line: "Food security and water stewardship, starting in Riyadh." },
] as const;
